  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden ">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <div
          className="absolute top-1/2 left-1/2 w-24 h-24 bg-accent/10 rounded-full blur-2xl animate-float"
        ...
        <div className="text-center space-y-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Extract summaries, transcripts, and key insights from any podcast
              in seconds. Upload audio files or paste YouTube links to unlock
              the power of AI-driven content analysis.
            </p>
          </div>
          ...
          >
            <Button
              size="lg"
              className="px-8 py-6 text-lg bg-gradient-primary hover:shadow-[0_0_30px_hsl(var(--primary)/0.5)] transition-all duration-300"
            >
            ...
            <Button
              variant="outline"
              size="lg"
              className="px-8 py-6 text-lg border-border/30 hover:border-primary/50"
            >
      ...
      <div className="absolute mt-9 bottom-0 left-0 right-0 h-32 flex items-end justify-center gap-1 opacity-20 z-10">
